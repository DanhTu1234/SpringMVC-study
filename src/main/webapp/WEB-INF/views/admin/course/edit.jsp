            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form id="formSubmit">
                                ...
                                <select class="form-control" id="category_id" name="category_id">
                                    ...
                                    <c:forEach var="item" items="${categories}">
                                        <option value="${item.id}"
                                                <c:if test="${item.id == model.categoryCourseId}">selected="selected"</c:if>>
                                                ${item.name}
                                        </option>
                                    </c:forEach>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right">Tên khóa học</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="fullName" name="fullName" value="${model.fullName}"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right">Tên ngắn</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                ...
                                <input type="button" class="btn btn-white btn-warning btn-bold" value="Cập nhật khóa học" id="btnUpdateCourse"/>
